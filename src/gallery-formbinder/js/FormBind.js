YUI().add('FormBind', function(Y) {
    var FORMBIND_NAME = 'FormBind',
        ...
        tagBindings = {
            input: function(target, name, value) {
                target.set('value', value);
            },
            textarea: function(target, name, value) {
                target.set('value', value);
            },
            select: function(target, name, value) {
            ...
            fieldset: function(target, name, value, data, form) {
    ...
    Y[FORMBIND_NAMESPACE][FORMBIND_NAME] = {
        ...
        formBind: function(data, formId) {
            var target = null,  // element in form we're targeting 
                prop = null,    // a name of a data in the data object 
                label = '',     // possible label of the data object
            ...
            if (data.date && data.format) {
                var d = new Date(Date.parse(data.date, data.format));
